...
- Search and open recent Neovim sessions (persistence.nvim, recent directories, shada)
- Open selected Finder files/folders in Neovim
- Open a new Neovim window in any terminal
- Browse installed plugins from lazy-lock.json with GitHub links
...
**Tested with:** Ghostty and Terminal.app + LazyVim. Would love for people to try other terminals (iTerm2, kitty, Alacritty, WezTerm) and Neovim distributions and contribute!
